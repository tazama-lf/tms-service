...
ENV QUOTING=false
ENV SERVER_URL=
ENV TRANSACTIONHISTORY_DATABASE_CERT_PATH=
ENV MAX_CPU=
...
# Database
ENV TRANSACTIONHISTORY_DATABASE_URL=
ENV TRANSACTIONHISTORY_DATABASE_USER=root
ENV TRANSACTIONHISTORY_DATABASE_PASSWORD=
